...
export class FileVariableReferenceProvider implements ReferenceProvider {
    public async provideReferences(
        ...
        const wordRange =
            VariableUtility.getEnvironmentOrFileVariableReferenceNameRange(document, position) ||
        ...
        const referenceLocations = VariableUtility.getFileVariableReferenceRanges(
            documentLines,
            selectedVariableName
        );
